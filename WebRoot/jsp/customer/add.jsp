...
<script type="text/javascript">
	$(function() {
	<!--客户级别-->
		$.post("${pageContext.request.contextPath }/baseDictAction.action", {
			"dict_type_code" : "006"
		},
			function(data) {
						...
						<TABLE cellSpacing=0 cellPadding=5 border=0>
							...
							<TR>
								...
								<td>
									...
									maxLength=50 name="cust_level"> --> <select id="cust_level" name="baseDictLevel.dict_id">
							...
							<TR>
								...
								<td>
									<!-- <INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="cust_source"> --> <select id="cust_source" name="baseDictSource.dict_id">
										<option value="">--请选择--</option>
								</select>
								...
								<td>
									<!-- <INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 name="cust_industry"> --> <select id="cust_industry" name="baseDictIndustry.dict_id">
										<option value="">--请选择--</option>
								</select>
							...
							<TR>
								...
								<td>公司资质 ：</td>
								<td><INPUT class=textbox id=sChannel2 style="WIDTH: 180px"
									maxLength=50 type="file" name="upload"></td>
							</TR>
