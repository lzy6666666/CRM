...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/customer_find.action"
		method=post>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												<option value="6" <s:if test="pageSize==6">selected="selected"</s:if>>6</option>
												<option value="9" <s:if test="pageSize==9">selected="selected"</s:if>>9</option>
												</select>
												条
