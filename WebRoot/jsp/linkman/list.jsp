										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/jsp/linkman/edit.jsp?lkm_id=<s:property value="lkm_id"/>">修改</a>
													&nbsp;&nbsp;
									...
									<TD><SPAN id=pagelink>
											<DIV
												...
												共[<B><s:property value="totalCount" /></B>]条记录,[<B><s:property
													...
													<option value="9"
														<s:if test="pageSize==9">selected="selected"</s:if>>9</option>
												</select> 条
												<s:if test="currPage != 1">
												[<A
														href="javascript:to_page(<s:property value="currPage-1"/>)">前一页</A>]
												</s:if>
												<B><s:property value="currPage"/></B>
